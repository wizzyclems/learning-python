...
# to the extension h. To do this, we would like to generate a new list called newfilenames, 
# consisting of the new filenames. Fill in the blanks in the code using any of the 
