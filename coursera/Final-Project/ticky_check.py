...
def parseSysLog():
  ...
  with open(os.path.expanduser('~') + '/wizzyapps/wizzypython/coursera/Final-Project/error_message.csv', mode='w',encoding='UTF-8') as error_file :
  ...
  with open(os.path.expanduser('~') + '/wizzyapps/wizzypython/coursera/Final-Project/user_statistics.csv', mode='w',encoding='UTF-8') as user_file :
