...
# count_letters("This is a sentence.") should 
...
def count_letters(text):
  ...
  for letter in text:
    # Check if the letter needs to be counted or not
    if letter.isdigit() or letter.isspace() or letter in "'!.=+" :
        #print("The letter '{}' is either a digit, space or special xter".format(letter.lower()))
        continue
    
    # Add or increment the value in the dictionary
    if letter not in result :
        result[letter.lower()] = 0
        #print("The letter {} is initialized.".format(letter.lower()))
